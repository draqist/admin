...
export const FxOptionsModal = ({ title, close, optionsOpen, local }: FxOptionsModalProps) => {
  return (
    <Modal opened={optionsOpen} onClose={close} title={`Send ${title}`} centered>
      <a className="flex items-center justify-between mb-3" role="link" href="/transactions">
        <div className="text-[#6882B6]">
          <h3 className="text-2xl font-semibold"> Send Fund </h3>
          <span className="text-sm font-semibold">Send to foreign account </span>
        </div>
        <ArrowRight />
      </a>
      <Divider my="sm"/>
      <a className="flex items-center justify-between mb-3" role="link" href="/transactions">
        <div className="text-[#6882B6]">
          ...
          <span className="text-sm font-semibold">Convert to other currencies </span>
        </div>
        <ArrowRight />
      </a>
      <Divider my="sm"/>
...
export const NairaOptionsModal = ({ title, close, optionsOpen }: FxOptionsModalProps) => {
  return (
    <Modal opened={optionsOpen} onClose={close} title={"Naira Exchange"} centered>
      <a className="flex items-center justify-between mb-3" role="link" href="/transactions">
        <div className="text-[#6882B6]">
          <h3 className="text-2xl font-semibold"> Send Fund </h3>
          <span className="text-sm font-semibold">Send to foreign account </span>
